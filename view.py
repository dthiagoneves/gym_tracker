...
class SessionInput(ctk.CTkFrame):
    def __init__(self, *args, **kwargs):
        ...
        self.button_plus.grid(row=0, column=0, padx=0, pady=5)

        self.button_minus = ctk.CTkButton(self, text="-", width=15, height=15, command=self.delete_input)
        self.button_minus.grid(row=0, column=1, padx=0, pady=5)
    ...
    def create_input(self):
        ...
        label.grid(row=_index+1, column=0, padx=10, pady=10)
        ...
        entry.grid(row=_index+1, column=1, padx=10, pady=10)
